...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-003.png}
...
>plotSegment(L,Q,"c"):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-004.png}
\begin{eulercomment}
3.)
\end{eulercomment}
\begin{eulerprompt}
...
>color(3); plotLine(k):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-005.png}
\begin{eulerprompt}
>plotSegment(P,L,"r"):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-006.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-018.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-020.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-021.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  H: useglobal; return abs(a)*abs(ysol)/2 
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-028.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Ada juga metode Lagrange, memaksimalkan H (a, b, c) ^ 2 terhadap a + b
+ d = d.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-052.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-055.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{29}{images/EMTGeometry_Aulina M_223051440043-062.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-071.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-097.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-104.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-105.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-106.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-108.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-109.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-111.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-112.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-113.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-115.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-116.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-117.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-121.png}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-123.png}
...
>plotSegment(A,B,""):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-124.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-125.png}
\begin{eulerprompt}
>color(6); plotSegment(A,k,""); plotSegment(A,n,""); plotSegment(k,l,""); plotSegment(l,B,""); plotSegment(B,m,""); plotSegment(m,n,""):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-126.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-127.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-128.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-129.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-130.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-131.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-132.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-133.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-134.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{24}{images/EMTGeometry_Aulina M_223051440043-135.png}
\end{eulernotebook}
\end{document}
