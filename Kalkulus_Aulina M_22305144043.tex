...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-001.png}
\begin{eulerprompt}
...
>plot2d("p(x)"):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-002.png}
\begin{eulercomment}
2. Fungsi 2
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d("a(x)"):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-003.png}
\begin{eulercomment}
3. Fungsi 3
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d("b(x)"):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-004.png}
\begin{eulerprompt}
>      
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-005.png}
\begin{eulercomment}
5. Fungsi 5
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d("d(x)"):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-006.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-007.png}
\begin{eulercomment}
2. Fungsi 2
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-008.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-012.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-018.png}
\begin{eulerprompt}
...
>plot2d("sin(1/x)",-5,5):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-028.png}
\eulerheading{Latihan}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\lim_{x\rightarrow 3}{\frac{2\,x-4}{x+2}}=\frac{2}{5}
\]
\end{eulerformula}
\begin{eulerprompt}
> plot2d("(2*x-4)/(x+2)",-2,8,-1,4):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-030.png}
\begin{eulercomment}
2. Fungsi 2
\end{eulercomment}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\lim_{x\rightarrow 2}{\frac{x^2+1}{2\,x-3}}=5
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("(x^2+1)/(2*x-3)",-5,5):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-032.png}
\begin{eulercomment}
3. Fungsi 3
\end{eulercomment}
\begin{eulerformula}
...
>plot2d("2x",1,5,-1,25):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-034.png}
\begin{eulercomment}
4. Fungsi 4
\end{eulercomment}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\lim_{x\rightarrow 4}{\frac{\sin x-1}{x}}=\frac{\sin 4}{4}-\frac{1
 }{4}
\]
\end{eulerformula}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-036.png}
\begin{eulercomment}
5. Fungsi 5
\end{eulercomment}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\lim_{x\rightarrow 3}{\frac{\sin x}{x}-1}=\frac{\sin 3}{3}-1
\]
\end{eulerformula}
\begin{eulerprompt}
>plot2d("sin(x)/x-1",-5,5):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-038.png}
\begin{eulerprompt}
> 
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-052.png}
\eulerheading{Latihan}
\begin{eulercomment}
Bukalah buku Kalkulus. Cari dan pilih beberapa (paling sedikit 5
fungsi berbeda tipe/bentuk/jenis) fungsi dari buku tersebut, kemudian
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-054.png}
\begin{eulercomment}
2. Fungsi 2
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d(["f(x)","df(x)"],-pi,pi,color=[blue,red]):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-057.png}
\begin{eulercomment}
3. Fungsi 3
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\lim_{h\rightarrow 1}{\frac{\cos \left(x+h\right)\,\sin \left(x+h
 \right)-\cos x\,\sin x}{h}}=\cos \left(x+1\right)\,\sin \left(x+1
 \right)-\cos x\,\sin x
\]
\end{eulerformula}
\begin{eulerprompt}
...
>plot2d(["f(x)","df(x)"],-pi,pi,color=[yellow,red]):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-060.png}
\begin{eulercomment}
4. Fungsi 4
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d(["f(x)","df(x)"],-pi,pi,color=[blue,red]):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-063.png}
\begin{eulercomment}
5. Fungsi 5
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\lim_{h\rightarrow 2}{\frac{\tan \left(x+h\right)^2-\tan x^2}{h}}=
 \frac{\tan \left(x^2+4\,x+4\right)-\tan x^2}{2}
\]
\end{eulerformula}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-066.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-080.png}
\begin{eulercomment}
Integral tentu
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-083.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\int {x^2-4\,x}{\;dx}=\frac{x^3}{3}-2\,x^2
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\int_{0}^{5}{x^2-4\,x\;dx}=-\frac{25}{3}
\]
\end{eulerformula}
\begin{eulerprompt}
>x=0:0.1:4; plot2d(x,f(x+0.01),>bar); plot2d("f(x)",0,5,>add):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-087.png}
\begin{eulerprompt}
> 
\end{eulerprompt}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\int {\cos ^2x+5}{\;dx}=\frac{\frac{\sin \left(2\,x\right)}{2}+x}{2
 }+5\,x
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\int_{0}^{\frac{\pi}{2}}{\cos ^2x+5\;dx}=\frac{11\,\pi}{4}
\]
\end{eulerformula}
\begin{eulerprompt}
>x=0:0.1:pi-0.1; plot2d(x,f(x+0.02),>bar); plot2d("f(x)",0,pi,>add):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-091.png}
\begin{eulercomment}
3. Fungsi 3
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\int {\sqrt{x^2+3}}{\;dx}=\frac{3\,{\rm asinh}\; \left(\frac{x}{
 \sqrt{3}}\right)}{2}+\frac{x\,\sqrt{x^2+3}}{2}
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\int_{-2}^{1}{\sqrt{x^2+3}\;dx}=\frac{3\,{\rm asinh}\; \left(\frac{
 2}{\sqrt{3}}\right)+2\,\sqrt{7}}{2}+\frac{3\,{\rm asinh}\; \left(
 \frac{1}{\sqrt{3}}\right)+2}{2}
\]
\end{eulerformula}
\begin{eulerprompt}
>x=0:0.04:3; plot2d(x,f(x+0.01),>bar); plot2d("f(x)",-pi,pi,>add):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-095.png}
\begin{eulercomment}
4. Fungsi 4
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-099.png}
\begin{eulercomment}
5. Fungsi 5
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
-2\,\int {\sin ^2x}{\;dx}=\frac{\sin \left(2\,x\right)}{2}-x
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
-2\,\int_{-\pi}^{\pi}{\sin ^2x\;dx}=-2\,\pi
\]
\end{eulerformula}
\begin{eulerprompt}
>x=-pi:0.04:pi; plot2d(x,f(x+0.01),>bar); plot2d("f(x)",-pi,pi,>add):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-103.png}
\begin{eulercomment}
6. Fungsi 6
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-105.png}
\begin{eulerprompt}
>0.01*sum(f(x+0.01))
\end{eulerprompt}
\begin{euleroutput}
...
>x=0:0.1:pi-0.01; plot2d(x,f(x+0.01),>bar); plot2d("f(x)",0,pi,>add):
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-107.png}
\begin{eulerprompt}
>0.01*sum(f(x+0.01))
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-109.png}
\begin{eulerprompt}
>0.01*sum(f(x+0.01))
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-112.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-116.png}
\begin{eulercomment}
2. Fungsi 2
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-119.png}
\begin{eulerprompt}
>function h(x) &= f(x)-g(x); $h(x)
\end{eulerprompt}
\begin{eulerformula}
...
\left[ x=\frac{\frac{\sqrt{3}\,i}{2}-\frac{1}{2}}{3\,\left(\frac{
 \sqrt{671}}{2\,3^{\frac{3}{2}}}+\frac{5}{2}\right)^{\frac{1}{3}}}+
 \left(\frac{\sqrt{671}}{2\,3^{\frac{3}{2}}}+\frac{5}{2}\right)^{
 \frac{1}{3}}\,\left(-\frac{\sqrt{3}\,i}{2}-\frac{1}{2}\right) , x=
 \left(\frac{\sqrt{671}}{2\,3^{\frac{3}{2}}}+\frac{5}{2}\right)^{
 \frac{1}{3}}\,\left(\frac{\sqrt{3}\,i}{2}-\frac{1}{2}\right)+\frac{-
 \frac{\sqrt{3}\,i}{2}-\frac{1}{2}}{3\,\left(\frac{\sqrt{671}}{2\,3^{
 \frac{3}{2}}}+\frac{5}{2}\right)^{\frac{1}{3}}} , x=\left(\frac{
 \sqrt{671}}{2\,3^{\frac{3}{2}}}+\frac{5}{2}\right)^{\frac{1}{3}}+
 \frac{1}{3\,\left(\frac{\sqrt{671}}{2\,3^{\frac{3}{2}}}+\frac{5}{2}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-123.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Kalkulus_Aulina M_22305144043-126.png}
\begin{eulerprompt}
