...
\end{euleroutput}
\begin{eulerprompt}
>\{x,y\}=rect(90°,sqrt(2)); [x,y]
\end{eulerprompt}
\begin{euleroutput}
  [0,  1.41421]
\end{euleroutput}
\begin{eulerprompt}
>\{phi,r\}=polar(4,2); degprint(phi), r,
\end{eulerprompt}
\begin{euleroutput}
  26°33'54.18''
  4.472135955
...
\end{eulerprompt}
\eulerimg{24}{images/euler Aulina-007.png}
\begin{eulerprompt}
>x=10^(1:20); y=x^2-x;
>plot2d(x,y,logplot=2):
\end{eulerprompt}
\eulerimg{24}{images/euler Aulina-008.png}
\eulersubheading{}
\begin{eulercomment}
