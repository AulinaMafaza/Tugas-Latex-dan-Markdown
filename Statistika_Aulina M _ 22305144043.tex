...
>boxplot(M):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-003.png}
\eulersubheading{}
...
\end{eulerprompt}
\begin{euleroutput}
  Could not open the file table.dat!
  printfile:  open(filename,"r");
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  MT is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  Table is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  MT1 is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  tok is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  Could not open the file test.dat!
  readtable:  open(filename,"r");
\end{euleroutput}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  Cannot combine a 1x1 and a 1x0 matrix for *!
  writetable:     if typeof(wc)==0 then wc=wc*ones(1,cols(x)); endif;
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2 }(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function clopperpearson not found.
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-012.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-015.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-026.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  median:             if i0==n then return xs[n]; endif;
  medianexpand: useglobal; return median(x,p=linspace(0,1,n-1)); 
\end{euleroutput}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Could not open the file table1.dat!
  readtable:  open(filename,"r");
\end{euleroutput}
\begin{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  MS is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  cs is not a variable you can index with []!
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-031.png}
\eulersubheading{}
\eulerheading{TEST}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-032.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-033.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  ...
  makef: return \{\{t,u,indexofsorted(u,t)\}\};
...
\end{eulerprompt}
\begin{euleroutput}
  statef is not a variable you can index with []!
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Statistika_Aulina M _ 22305144043-036.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  L is not a variable you can index with []!
...
\end{eulerprompt}
\begin{euleroutput}
  0.2409814700872754 0.558900038016263 0.6984542945253732 
  0.2560195102177832 0.701352349768835 0.7017325305600023 
  0.8873413430638677 0.6003998834798067 0.4526496834471929 
  0.9753935634663575 0.542291415433758 0.2449892111234753 
  0.5921916986518979 0.6323504721512041 0.4408846374019954 
...
\begin{euleroutput}
  A,B,C
  0.7003664386138074 0.1875530821001213 0.3262339279660415 
  0.5926249243193859 0.1522927283984059 0.368140583062521 
...
\end{eulerprompt}
\begin{euleroutput}
    0.82212  0.821531  0.777124 
   0.848295  0.323777  0.650142 
    0.14823  0.329746   0.62619 
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Could not open the file excel-data.csv!
  printfile:  open(filename,"r");
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  Could not open the file excel-data.csv!
  readmatrix:     if filename<>"" then open(filename,"r"); endif;
\end{euleroutput}
\begin{eulercomment}
Let us plot this.
\end{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function day needs at least 3 arguments!
  Use: day (y: integer scalar, m: integer scalar, d: integer scalar \{, h: integer scalar, min: number\}) 
...
\begin{euleroutput}
  ...
  Error in expression: 2020-11-03,Tue,1'114.05
...
\begin{euleroutput}
  Function strxfind not found.
  Try list ... to find functions!
  readtd:    \{pos,s,vt\}=strxfind(line,"<td.*?>(.+?)</td>",cp);
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Function urlopen not found.
  Try list ... to find functions!
  readversion: urlopen("http://www.euler-math-toolbox.de/Programs/Changes.ht ...
\end{euleroutput}
...
\begin{euleroutput}
  ...
  0.5167243983231363, 0.2996684599070899];
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [0.344851,  0.080751,  0.87652,  0.754158,  0.688393]
\end{euleroutput}
\end{eulernotebook}
\end{document}
