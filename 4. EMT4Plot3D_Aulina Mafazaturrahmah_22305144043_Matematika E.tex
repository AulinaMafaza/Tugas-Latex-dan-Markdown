...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-001.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-008.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-011.png}
...
\begin{euleroutput}
  ...
  f3dplotlight:           niveau=(niveau-z0)*h;
  plot3d:                         contourcolor,contourwidth,dl,limits;args());
\end{euleroutput}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-016.png}
\begin{eulercomment}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-022.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-023.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-028.png}
\begin{eulercomment}
*Plot Statistik
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-031.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-032.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-033.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-037.png}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function plotcontourplane not found.
  Try list ... to find functions!
  myplot:   plotcontourplane(x,y,z,level="auto",<scale);
\end{euleroutput}
...
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-039.png}
...
biasanya c: \(\backslash\) Users \(\backslash\) Username \(\backslash\) Euler. Povray menghasilkan file PNG,
...
See: Examples\(\backslash\)Trefoil Knot | Trefoil Knot
...
>plot3d("3x^3+4y^2"):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-040.png}
\begin{eulercomment}
2. Buatkan grafik
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulercomment}
dengan a=-1, b=4, dan grid=12
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^2-3*x+2",a=-1,b=4,rotate=true,grid=12):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-041.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>plot3d("exp(4*x*y)",angle=120°,>contour,color=blue):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-042.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>plot3d("2*x^2+y^3+5*x*z+3*z^3",>implicit,r=3,zoom=2.5):
\end{eulerprompt}
\eulerimg{19}{images/4. EMT4Plot3D_Aulina Mafazaturrahmah_22305144043_Matematika E-043.png}
\begin{eulercomment}
5. Buatlah perintah untuk menggambarkan grafik povray
\end{eulercomment}
\begin{eulerprompt}
>pov3d("x^3-y^2",axiscolor=black,angle=70°, ...
>  look=povlook(yellow,0.4),level=-1:0.5:1,zoom=4);
\end{eulerprompt}
\begin{euleroutput}
  exec:   return _exec(program,param,dir,print,hidden,wait);
  povray:     exec(program,params,defaulthome);
  pov3d:      if povray then povray(currentfile,w,h,w/h); endif;
\end{euleroutput}
\begin{eulercomment}
6. Buatlah plot 3D dari fungsi 
\end{eulercomment}
\begin{eulerformula}
\[
f(x)=4x^2+2y^3
...
\end{eulerformula}
\begin{eulercomment}
dengan menggunakan mode anaglyph dan sudutnya 40 derajat
\end{eulercomment}
\begin{eulerprompt}
>plot3d("4*x^2+2y^3",>anaglyph,>contour,angle=40°):
\end{eulerprompt}
\end{eulernotebook}
\end{document}
