...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{14}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-027.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-029.png}
\begin{eulerprompt}
...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-030.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-031.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-032.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-036.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-037.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-042.png}
\begin{eulercomment}
Dalam contoh berikut, kami menghasilkan Bernstein-Polinomial.

lateks: B_i(x) = \(\backslash\)binom\{n\}\{i\} x^i (1-x)^\{n-i\}
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-043.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-045.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-049.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-051.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-056.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-057.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-061.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-062.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-063.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-064.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-066.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-067.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-069.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-070.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-074.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-075.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-076.png}
\begin{eulercomment}
Jika x adalah vektor yang diurutkan, dan y adalah vektor interval,
maka plot2d akan memplot rentang interval yang terisi dalam bidang.
Gaya isian sama dengan gaya poligon.
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-077.png}
\begin{eulercomment}
Kami juga dapat mengisi rentang nilai seperti

lateks: -1 \(\backslash\)le (x^2+y^2)^2-x^2+y^2 \(\backslash\)le 0.
\end{eulercomment}
\begin{eulerprompt}
>plot2d("(x^2+y^2)^2-x^2+y^2",r=1.2,level=[-1;0],style="/"):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-078.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-079.png}
...
lateks: \(\backslash\)gamma(t) = t \(\backslash\)cdot (\(\backslash\)cos(2\(\backslash\)pi t),\(\backslash\)sin(2\(\backslash\)pi t))
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-081.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-082.png}
\begin{eulercomment}
Dalam contoh berikutnya, kami memplot kurva

lateks: \(\backslash\)gamma(t) = (r(t) \(\backslash\)cos(t), r(t) \(\backslash\)sin(t))

dengan

lateks: r(t) = 1 + \(\backslash\)dfrac\{\(\backslash\)sin(3t)\}\{2\}.
\end{eulercomment}
\begin{eulerprompt}
>t=linspace(0,2pi,1000); r=1+sin(3*t)/2; x=r*cos(t); y=r*sin(t); ...
>plot2d(x,y,>filled,fillcolor=red,style="/",r=1.5):
\end{eulerprompt}
\eulerimg{16}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-083.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-084.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-085.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-086.png}
\begin{eulercomment}
...
lateks: \(\backslash\)gamma(t) = e^\{it\}
\end{eulercomment}
\begin{eulerprompt}
>t=linspace(0,2pi,1000); ...
>plot2d(exp(I*t)+exp(4*I*t),r=2):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-087.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-089.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-090.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-091.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-092.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-093.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-094.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-095.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-097.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-099.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-102.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-103.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-104.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-105.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-106.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-108.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-110.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-111.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-112.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-113.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-115.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-116.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-117.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-118.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-119.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-120.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-121.png}
\begin{eulercomment}
Juga dimungkinkan untuk mengisi set

lateks: a \(\backslash\)le f(x,y) \(\backslash\)le b
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-123.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-124.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-125.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-127.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-128.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-130.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-131.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-132.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-133.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-135.png}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-136.png}
\begin{eulercomment}
...
>plot2d("x^3+5"):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-137.png}
\begin{eulercomment}
3. Gambarkan kurva
\end{eulercomment}
\begin{eulerformula}
...
>plot2d("tan(x)",0,2pi):
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Aulina Mafazaturrahmah_22305144043_Tugas2-140.png}
